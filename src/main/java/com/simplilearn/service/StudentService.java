...
public interface StudentService {
	...
	/**
	 * Enrolls a student in a specified course. If the student does not exist, they
	 * are added to the database.
	 * 
	 * @param studentId the student details
	 * @param courseId   the ID of the course to enroll the student in
	 * @return the updated StudentDTO with the new course enrollment
	 */
